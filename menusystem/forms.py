...
from .checkout_validators import (
...
class MealOrderForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if self.user.is_authenticated:
            first_validator.set_next(is_new_order_validator)
        else:
            ...
            # authentication flow
            first_validator.set_next(can_authenticate_validator).set_next(
                is_new_order_validator
            )
        ...
        cleaned_data["employee"] = request["user"]
        return cleaned_data
